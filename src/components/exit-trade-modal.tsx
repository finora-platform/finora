...
export const ExitTradeModal = ({
  ...
  const handleSubmit = async () => {
    if (
      isRange &&
      Number(exitData.exitPrice) >= Number(exitData.exitPriceMax)
    ) {
    ...
    try {
      ...
      const cleanTradeData = Object.fromEntries(
        Object.entries(tradeData).filter(
      ...
      <DialogContent className="max-w-md sm:max-w-[450px] px-6 py-5">
          ...
          {isRange ? (
            <div className="flex gap-2">
              <Input
                ...
                onChange={(e) =>
                  setExitData({ ...exitData, exitPrice: e.target.value })
                }
              />
              <Input
                placeholder="₹ Max"
                ...
                onChange={(e) =>
                  setExitData({ ...exitData, exitPriceMax: e.target.value })
                }
              />
            </div>
          ) : (
        ...
        <div className="mt-4 space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setExitData({ ...exitData, exitReason: e.target.value })
            }
          />
        </div>
